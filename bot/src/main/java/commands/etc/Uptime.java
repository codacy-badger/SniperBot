    ...
    public void action(String[] args, MessageReceivedEvent event) throws ParseException, IOException {
        ...
        event.getTextChannel().sendMessage(
                new EmbedBuilder()
                        ...
                        .addField(":calendar:Last restart", getTime(STATICS.lastRestart, "dd.MM.yyyy - HH:mm:ss (z)"), false)
                        .addField(":history: Online since", getTimeDiff(new Date(), STATICS.lastRestart), false)
